...
def which_button(m, event): #when correct button clicked, used to store list of correct animals so far
    global list_correct_animals
    #adding to list of correct animals
    list_correct_animals=list_correct_animals + "\n" + m
    #disabling the button which was just pressed
    button = event.widget
...
def wrong_answer6(m):
    ...
    try_again6= Button(master=lvl6_game, text=("Try again"), width=42, height=10, command=undo_wrong_answer6, bg="grey", fg="black", font=("Comic Sans MS", 14))
...
def wrong_answer5(m):
    ...
    try_again5= Button(master=lvl5_game, text=("Try again"), width=42, height=10, command=undo_wrong_answer5, bg="grey", fg="black", font=("Comic Sans MS", 14))
...
def wrong_answer4(m):
    ...
    try_again4= Button(master=lvl4_game, text=("Try again"), width=42, height=10, command=undo_wrong_answer4, bg="grey", fg="black", font=("Comic Sans MS", 14) )
...
def wrong_answer3(m):
    ...
    try_again3= Button(master=lvl3_game, text=("Try again"), width=42, height=10, command=undo_wrong_answer3, bg="grey", fg="black", font=("Comic Sans MS", 14))
...
def wrong_answer2(m):
    ...
    try_again2= Button(master=lvl2_game, text=("Try again"), width=42, height=10, command=undo_wrong_answer2, bg="grey", fg="black", font=("Comic Sans MS", 14))
...
def wrong_answer(m): #when wrong button clicked, ONLY FOR 1ST LEVEL
    ...
    global try_again
    #message for incorrect answer
    try_again= Button(master=lvl1_game, text=("Try again"), width=42, height=10, command=undo_wrong_answer, bg="grey", fg="black", font=("Comic Sans MS", 14))
