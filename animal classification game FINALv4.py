...
def Level6():
    ...
    animals_found_label6 = Label(lvl6_game, text="ANIMALS FOUND: ", height=10, width=20, font=(("Times New Roman"), 18), fg="black", bg="light green")
    global animal_found_list6
    animal_found_list6= Label(lvl1_game, text="", font=(("comic sans MS"), 12), bg="#4c5751")
    ...
    animals_found_label6.place(x=500, y=50)
    animal_found_list6.place(x=510, y=250)
...
def wrong_answer5(m): #when wrong answer chosen in level 5
    ...
    #message for incorrect answer
    oops5= Label(master=lvl5_game, text="Oops! " + justification + "\n"+"\n" +"If your stuck try going back to the" +"\n" +" instructions page for a hint!",
...
def Level5():
    ...
    animals_found_label5 = Label(lvl5_game, text="ANIMALS FOUND: ", height=10, width=20, font=(("Times New Roman"), 18), bg="#cca47c")
    global animal_found_list5
    animal_found_list5= Label(lvl1_game, text="", font=(("comic sans MS"), 12), bg="#4c5751")
    ...
    animals_found_label5.place(x=500, y=50)
    ...
    animal_found_list5.place(x=510, y=250)
...
def wrong_answer4(m): #when wrong option chosen in level 4
    ...
    #message for incorrect answer
    oops4= Label(master=lvl4_game, text="Oops! " + justification + "\n"+"\n" +"If your stuck try going back to the" +"\n" +" instructions page for a hint!",
...
def Level4():
    ...
    animals_found_label4 = Label(lvl4_game, text="ANIMALS FOUND: ", height=10, width=20, font=(("Times New Roman"), 18), bg="#877c94", fg="black")
    global animal_found_list4
    animal_found_list4= Label(lvl1_game, text="", font=(("comic sans MS"), 12), bg="#4c5751")
    ...
    animals_found_label4.place(x=500, y=50)
    ...
    animal_found_list4.place(x=510, y=250)
...
def wrong_answer3(m): #when wrong anser chosen in level 3
    ...
    #message for incorrect answer
    oops3= Label(master=lvl3_game, text="Oops! "+ justification + "\n"+"\n" +"If your stuck try going back to the" +"\n" +" instructions page for a hint!",
...
def Level3():
    ...
    animals_found_label3 = Label(lvl3_game, text="ANIMALS FOUND: ", height=10, width=20, font=(("Times New Roman"), 18), background="light blue", fg="black")
    global animal_found_list3
    animal_found_list3= Label(lvl1_game, text="", font=(("comic sans MS"), 12), bg="#4c5751")
    ...
    animals_found_label3.place(x=500, y=50)
    ...
    animal_found_list3.place(x=510, y=250)
...
def correct_choice2(m): #when correct option chosen in level 2
    ...
    if points<2:
        ...
        animal_found_list2.config(text=list_correct_animals)
        translate_widgets()
    else:
...
def wrong_answer2(m): #when wrong option chosen in level 2
    ...
    #message for incorrect answer
    oops2= Label(master=lvl2_game, text="Oops! " + justification + "\n"+"\n" +"If your stuck try going back to the" +"\n" +" instructions page for a hint!",
...
def Level2():
    ...
    animals_found_label2 = Label(lvl2_game, text="ANIMALS FOUND: ", height=10, width=20, font=(("Times New Roman"), 18), bg="#ebd483")
    global animal_found_list2
    animal_found_list2= Label(lvl1_game, text="", font=(("comic sans MS"), 12), bg="#4c5751")
    ...
    animals_found_label2.place(x=500, y=50)
    ...
    animal_found_list2.place(x=510, y=250)
...
def wrong_answer(m): #when wrong button clicked, UNIQUE TO EACH LEVEL
    ...
    global try_again
    #message for incorrect answer
    oops= Label(master=lvl1_game, text="Oops! " + justification + "\n" + "\n" +"If your stuck try going back to the" +"\n" +" instructions page for a hint!",
...
def Level1():
    ...
    animals_found_label = Label(lvl1_game, text="ANIMALS FOUND: ", height=10, width=20, font=(("Times New Roman"), 18), bg="#4c5751")
    global animal_found_list
    animal_found_list= Label(lvl1_game, text="", font=(("comic sans MS"), 12), bg="#4c5751")
    ...
    animals_found_label.place(x=510, y=50)
    animal_found_list.place(x=510, y=250)
...
# Create the menu.
settings_menu = Menu(menubar, tearoff=False, background="#686968", foreground="#ffffff")
...
# lang_menu = Menu(menubar, tearoff=False)
# settings_menu.add_cascade(menu=lang_menu, label="Language")
# lang_menu.add_cascade(
#     label="+",
#     command=scale_all_widgets(1.5)
# )   

settings_menu.add_command(
    label="Language options",
    command=change_language,
    background="#686968", foreground="#ffffff"
)
...
# quit_menu= Menu(menubar, tearoff=False)
# quit_menu.add_radiobutton(
#     label="click enter to quit",
#     state=DISABLED
# )

# # Append quit button to the menubar.
# menubar.bind("<<enter>>", close_game), root.onExit
menubar.add_cascade(label="Quit Game", background="#686968", foreground="#ffffff")
...
menubar.add_cascade(command=replay_game(), label="Replay", background="#686968", foreground="#ffffff")
...
# subprograms which update settings as frames change
