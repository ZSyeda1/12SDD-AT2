...
def EndScreeN(): #displays congrats screen if level 6 completed
    ...
    #backgrouns
    congrats_bg = (PIL.Image.open("congrats_bg.jpg")).resize((800, 400))
    ...
    def reset_timer():
        ...
        # Set up a new timer
        timer_id = root.after(60000, show_message)
...
def correct_choice6(m): #when a correct option is chosen in lvl6
    ...
    if points<2:
        ...
        #bg
        backyard_bg = (PIL.Image.open("backyard_bg.png")).resize((800, 400))
...
def transition5(): #hide level 5 summary and show level 6 instructions
    ...
    global cont6
    cont6 =  Button(instr_lvl6, text="Continue", relief="raised", bg="#c0facb", font=(("Comic Sans MS"), 8), command=Level6)
...
def correct_choice5(m): #when correct option chosen in level 5
    ...
    if points<2:
        ...
        #background
        outback_bg = (PIL.Image.open("outback_bg.png")).resize((800, 400))
...
def Level5():
    ...
    #Thorny Devil
    TDevil_img = PIL.Image.open("thorny-devil.jpg")
    ...
    #Bilby
    Bilby_img = PIL.Image.open("Bilby.png")
...
def transition4():
    ...
    global cont5
    cont5 =  Button(instr_lvl5, text="Continue", bg="#ebc6a2", command=Level5, font=(("Comic Sans MS"), 8), relief="raised")
...
def correct_choice4(m): #when correct option chosen in level 4
    ...
    #when 3 points reached
        ...
        #background
        BRF_bg = (PIL.Image.open("BRF_bg.png")).resize((800, 400))
        global BRF_photo
...
def transition3(): 
    ...
    global cont4
    cont4 =  Button(instr_lvl4, text="Continue", command=Level4, bg="#b7a7c9", font=(("Comic Sans MS"), 8), relief="raised")
...
def correct_choice3(m): #when correct option chosen in level 3
    ...
    #when score of 3 reached
        ...
        #background
        GBR_bg = (PIL.Image.open("GBR_bg.png")).resize((800, 400))
        global GBR_photo
...
def Level3():
    ...
    #blanket octapus
    Boctapus_img = PIL.Image.open("blanket-octopus.jpg")
    ...
    #giant clam
    Wshark_img = PIL.Image.open("whale-shark.jpg")
...
def transition2():
    ...
    global cont3
    cont3 =  Button(instr_lvl3, text="Continue", bg="#cad2fc", font=(("Comic Sans MS"), 8), command=Level3, relief="raised")
...
def correct_choice2(m): #when correct option chosen in level 2
    ...
    #score of 3 reached, display summary
        ...
        #background
        savanna_bg = PIL.Image.open("savanna_bg.png").resize((800, 400))
...
def transition1():
    ...
    global cont2
    cont2 =  Button(instr_lvl2, text="Continue", bg="#edda98", font=(("Comic Sans MS"), 8), command=Level2, relief="raised")
...
def correct_choice(m): #refects correct choice on screen; increment score and adds to list of animals found--UNIQUE TO EACH LEVEL
    ...
    if points<2: #score of 3 not reached
        ...
        #background
        amazon_bg = PIL.Image.open("amazon_bg.png")
        global amazon_photo
...
def Level1():
    ...
    #Macaw
    macaw_img = PIL.Image.open("blue_macaw.jpg")
    ...
    #capybara
    capybara_img = PIL.Image.open("capybara.jpeg")
    ...
    #jaguar
    jaguar_img = PIL.Image.open("jaguar.jpeg")
    ...
    #poison dart frog
    PDfrog_img = PIL.Image.open("poison-dart-frog.jpeg")
    ...
    #Pantalón-de-Cuerno
    Pcuerno_img = PIL.Image.open("Pantalón-de-Cuerno.jpg")
    ...
    #Red Howler Money
    RHMonkey_img = PIL.Image.open("red-howler-monkey.jpeg")
    ...
    BCSMonkey_img = PIL.Image.open("black-capped-squirrel-monkey.jpeg")
    ...
    #green anaconda
    GAnaconda_img = PIL.Image.open("green-anaconda.jpeg")
    ...
    CAToucan_img = PIL.Image.open("Toucan-Collared-Aracari.jpg")
...
def start(): #displayed first set of instruction
    ...
    global cont
    cont = Button(instr_lvl1, text="Continue", command=Level1, bg="#72827a", font=(("Comic Sans MS"), 8), relief="raised")

    #collage of birds-illustration of what birds look like
    birds_collage_image = PIL.Image.open("lvl-1-intro.png")
    ...
    def show_message():
        ...
        if res == 'yes' : 
            messagebox.showinfo('Return', 'Returning to application') 
...
def introduction(): #first screen displayed 
    ...
    #background of intro
    title_bg = PIL.Image.open("intro_screen_bg.png")
    global title_photo
    ...
    # Set up a timer for 1 minutes (60,000 milliseconds)
    global timer_id
    timer_id = root.after(60000, show_message)
