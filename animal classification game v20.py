...
def which_button(m, self): #when correct button clicked, used to store list of correct animals so far
    global list_correct_animals
    #adding to list of correct animals
    i=0
    for i in list_correct_animals:
        if list_correct_animals[i]==m:
            self.configure(state=DISABLED)
        else:
            list_correct_animals=[list_correct_animals + m]
...
def EndScreeN():
    ...
    congrats.bind("<Visibility>", update_widget_colour())
...
def correct_choice6(m):
    ...
    if points<2:
        ...
        lvl6_summary.bind("<Visibility>", update_widget_colour())
        menu_button.place_configure(x=750, y=0)
    menu_button.lift()
...
def Level6():
    ...
    lvl6_game.bind("<Visibility>", update_widget_colour())
...
def correct_choice5(m):
    ...
    if points<2:
        ...
        lvl5_summary.bind("<Visibility>", update_widget_colour())
        menu_button.place_configure(x=750, y=0)
    menu_button.lift()
...
def Level5():
    ...
    lvl5_game.bind("<Visibility>", update_widget_colour())
...
def transition4():
    ...
    instr_lvl5.bind("<Visibility>", update_widget_colour())
...
def correct_choice4(m):
    ...
    if points<2:
        ...
        lvl4_summary.bind("<Visibility>", update_widget_colour())
        menu_button.place_configure(x=750, y=0)
    menu_button.lift()
...
def Level4():
    ...
    lvl4_game.bind("<Visibility>", update_widget_colour())
...
def transition3():
    ...
    instr_lvl4.bind("<Visibility>", update_widget_colour())
...
def correct_choice3(m):
    ...
    if points<2:
        ...
        lvl3_summary.bind("<Visibility>", update_widget_colour())
        menu_button.place_configure(x=750, y=0)
    menu_button.lift()
...
def Level3():
    ...
    lvl3_game.bind("<Visibility>", update_widget_colour())
...
def transition2():
    ...
    instr_lvl3.bind("<Visibility>", update_widget_colour())
...
def correct_choice2(m):
    ...
    if points<2:
        ...
        lvl2_summary.bind("<Visibility>", update_widget_colour())
        menu_button.place_configure(x=750, y=0)
    menu_button.lift()
...
def Level2():
    ...
    lvl2_game.bind("<Visibility>", update_widget_colour())
...
def transition1():
    ...
    instr_lvl2.bind("<Visibility>", update_widget_colour())
...
def correct_choice(m, self): #refects correct choice on screen; increment score and adds to list of animals found--ONLY FOR 1ST LEVEL
    #increments points and adds correct animal to list
    which_button(m, self)
    global points
    global list_correct_animals
    if points<2: #score of 3 not reached
        ...
        lvl1_summary.bind("<Visibility>", update_widget_colour())
        menu_button.place_configure(x=750, y=0)
    menu_button.lift()
...
def Level1():
    ...
    def check_disable(self):
        #if widget.variable=="Button disabled":
        #if not widget.bind_class(disable_button, "<Button-1>"):
        global variable
        if widget.cget("textvariable")==variable:
            widget.configure(state=DISABLED)
            widget.unbind("<Button-1>")
            print(widget+"remains disabled")
    ...
    def disable_button(event):
        ...
        button.unbind("<Button-1>")
        variable.set("dis")
        button.configure(textvariable=variable)
        print(button)
    ...
    macaw_button =  customtkinter.CTkButton( text_color="black", master=lvl1_game, image=macaw_CTK, text="Blue and Gold Macaw", fg_color="#4c5751", font=("Comic Sans MS", 12), compound="bottom",
                                        command=lambda m="Blue and Gold Macaw":correct_choice (m, macaw_button))       
    ...
    Pcuerno_button =  customtkinter.CTkButton( text_color="black", master=lvl1_game, image=Pcuerno_CTK, text="Pantalón-de-Cuerno", fg_color="#4c5751", font=("Comic Sans MS", 12), compound="bottom",
                                        command=lambda m="Pantalón-de-Cuerno":correct_choice (m, Pcuerno_button))   
    ...
    CAToucan_button =  customtkinter.CTkButton( text_color="black", master=lvl1_game, image=CAToucan_CTK, text="Toucan Collared Aracari", fg_color="#4c5751", font=("Comic Sans MS", 12), compound="bottom",
                                        command= (lambda m="Toucan Collared Aracari":correct_choice (m, CAToucan_button)))
    ...
    if reappear==True:
        for widget in lvl1_game.winfo_children():
            if isinstance(widget, customtkinter.CTkButton):
                check_disable(widget)
        
    if reappear==False:
        for widget in lvl1_game.winfo_children():
            widget.bind("<Button-1>", disable_button)
            widget.configure(textvariable="not_dis")
    ...
    lvl1_game.bind("<Visibility>", update_widget_colour())
    menu_button.place_configure(x=750, y=0)
    menu_button.lift()
...
def start():
    ...
    instr_lvl1.bind("<displayed>", update_widget_colour())
    menu_button.place_configure(x=750, y=0)
    menu_button.lift()
