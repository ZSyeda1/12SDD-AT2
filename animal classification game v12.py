...
def wrong_answer5(m):
    ...
    def undo_wrong_answer5() :
        ...
        try_again5.destroy() 
    #message for incorrect answer
    oops5= Label(master=lvl5_game, text=("Oops, that isn't a reptile!" + "\n" + "Remember reptiles have scaly skin!"), width=800, height=400, bg="grey")
    oops5.place(x=0, y=0)
...
def wrong_answer6(m):
    ...
    def undo_wrong_answer6() :
        ...
        try_again6.destroy() 
    #message for incorrect answer
    oops6= Label(master=lvl6_game, text=("Oops, that isn't an invertebrate!" + "\n" + "Remember invertebrates don't have a spine and are really tiny!"), width=800, height=400, bg="grey")
    oops3.place(x=0, y=0)
...
summary_screen1= Label(master=lvl1_summary, text=("You've found the following Aves" + list_correct_animals), width=800, height=400, bg="grey")
...
summary_screen2= Label(master=lvl2_summary, text=("You've found the following mammals" + list_correct_animals), width=800, height=400, bg="grey")
...
summary_screen3= Label(master=lvl3_summary, text=("You've found the following fish" + list_correct_animals), width=800, height=400, bg="grey")
...
summary_screen4= Label(master=lvl4_summary, text=("You've found the following amphibians" + list_correct_animals), width=800, height=400, bg="grey")
